  ...
  methods: {
    ...
    registrarAsignacion1(){
        ...
        axios.put('/actual/actualizarasingacion',{
          ...
          window.open('http://200.105.132.229:8080/actual/repAsignaciones?codofic=' + this.cod_ofi + '&codresp='+ this.cod_resp +  '','_blank');
    ...
    registrarAsignacion2(){
        if (this.cod_ofi2==0 & this.cod_resp2==0) {
          swal.fire('Elija un Responsable','','error')
            ...
            Swal.fire(response.data.message, "", "success");
            window.open('http://200.105.132.229:8080/actual/repAsignaciones?codofic=' + this.cod_ofi2 + '&codresp='+ this.cod_resp2 +  '','_blank');
